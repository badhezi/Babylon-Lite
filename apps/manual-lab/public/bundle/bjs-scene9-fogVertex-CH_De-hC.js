import{bo as e}from"./bjs-scene9.js";const i="bonesDeclaration",f=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=f);const n="clipPlaneVertexDeclaration",a=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=a);const t="bonesVertex",c=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=c);const r="clipPlaneVertex",d=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=d);const s="fogVertex",u=`#ifdef FOG
#ifdef SCENE_UBO
