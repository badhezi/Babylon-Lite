import{a6 as e}from"./bjs-scene9.js";const o="decalFragmentDeclaration",u=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=u);const t="prePassDeclaration",p=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=p);const r="oitDeclaration",m=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=m);const i="lightFragmentDeclaration",S=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=S);const a="lightUboDeclaration",w=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);const c="samplerFragmentDeclaration",E=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=E);const n="reflectionFunction",C=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=C);const v="imageProcessingDeclaration",x=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=x);const d="imageProcessingFunctions",T=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=T);const f="depthPrePass",P=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=P);const h="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
