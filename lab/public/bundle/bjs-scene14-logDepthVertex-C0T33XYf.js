import{a7 as e}from"./bjs-scene14.js";const i="decalVertexDeclaration",V=`#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=V);const t="uvAttributeDeclaration",g=`#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=g);const r="bonesDeclaration",M=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=M);const n="bakedVertexAnimationDeclaration",O=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=O);const f="instancesDeclaration",L=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=L);const a="prePassVertexDeclaration",U=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=U);const d="samplerVertexDeclaration",C=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying vec2 v_VARYINGNAME_UV;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=C);const o="clipPlaneVertexDeclaration",F=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=F);const s="fogVertexDeclaration",X=`#ifdef FOG
varying vec3 vFogDistance;
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=X);const c="lightVxFragmentDeclaration",D=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=D);const m="lightVxUboDeclaration",W=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=W);const l="morphTargetsVertexGlobalDeclaration",B=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=B);const E="morphTargetsVertexDeclaration",H=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=H);const S="morphTargetsVertexGlobal",G=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=G);const I="morphTargetsVertex",w=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=w);const v="instancesVertex",b=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=b);const u="bonesVertex",y=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=y);const T="bakedVertexAnimation",$=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=z);const x="clipPlaneVertex",j=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=j);const R="fogVertex",K=`#ifdef FOG
vFogDistance=(view*worldPos).xyz;
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=K);const _="shadowsVertex",Z=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Z);const p="vertexColorMixing",q=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
