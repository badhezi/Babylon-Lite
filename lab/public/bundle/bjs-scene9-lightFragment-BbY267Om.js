import{bo as e}from"./bjs-scene9.js";const t="lightFragmentDeclaration",c=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);const o="lightUboDeclaration",f=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=h);const r="clusteredLightingFunctions",v=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=v);const a="shadowsFragmentFunctions",u=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=u);const s="reflectionFunction",p=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=p);const n="imageProcessingDeclaration",S=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=S);const l="imageProcessingFunctions",m=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=m);const d="lightFragment",g=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=g);
