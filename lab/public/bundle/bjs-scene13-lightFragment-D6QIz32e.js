import{a7 as e}from"./bjs-scene13.js";import"./bjs-scene13-oitFragment-BP7yPFGl.js";const i="clusteredLightingFunctions",d=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=r);const a="bumpFragmentFunctions",s=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);const o="bumpFragment",l=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=l);const n="decalFragment",h=`#ifdef DECAL
#ifdef GAMMADECAL
