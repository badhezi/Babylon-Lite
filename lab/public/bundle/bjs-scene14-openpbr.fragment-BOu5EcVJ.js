import{a7 as e}from"./bjs-scene14.js";import"./bjs-scene14-oitFragment-UGczBhmE.js";import"./bjs-scene14-openpbrUboDeclaration-CKTrTUyi.js";import"./bjs-scene14-pbrDebug-UrttuNLg.js";import"./bjs-scene14-logDepthDeclaration-CzSGv7n1.js";import"./bjs-scene14-helperFunctions-7rafgDo0.js";import"./bjs-scene14-harmonicsFunctions-BvWE8n_W.js";const a="openpbrFragmentSamplersDeclaration",N=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=N);const i="openpbrNormalMapFragmentMainFunctions",A=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=A);const n="openpbrNormalMapFragmentFunctions",T=`#if defined(GEOMETRY_NORMAL)
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=R);const K={name:r,shader:R};export{K as openpbrPixelShaderWGSL};
