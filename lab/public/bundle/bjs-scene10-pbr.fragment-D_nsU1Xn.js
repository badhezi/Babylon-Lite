import{S as e}from"./bjs-scene10.js";import"./bjs-scene10-logDepthDeclaration-BfvaNfaT.js";import"./bjs-scene10-fogFragment-DEprunUL.js";import"./bjs-scene10-helperFunctions-BFQ2sKg5.js";const t="prePassDeclaration",ne=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ne);const o="oitDeclaration",re=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=le);const r="pbrFragmentExtraDeclaration",ce=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=ce);const f="lightFragmentDeclaration",se=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=se);const l="lightUboDeclaration",de=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=de);const c="samplerFragmentDeclaration",ue=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=ue);const s="samplerFragmentAlternateDeclaration",Ee=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=Ee);const d="pbrFragmentSamplersDeclaration",ve=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ve);const u="imageProcessingDeclaration",he=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=he);const E="subSurfaceScatteringFunctions",me=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=me);const v="importanceSampling",Se=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=Se);const h="pbrHelperFunctions",pe=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=pe);const m="imageProcessingFunctions",Ce=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Ce);const S="shadowsFragmentFunctions",Re=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ge);const C="pbrDirectLightingSetupFunctions",Ae=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Ae);const R="pbrDirectLightingFalloffFunctions",Ie=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Ie);const g="hdrFilteringFunctions",Te=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Te);const A="pbrDirectLightingFunctions",Le=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Le);const I="pbrIBLFunctions",De=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=De);const T="bumpFragmentMainFunctions",Ne=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Ne);const L="bumpFragmentFunctions",Oe=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Oe);const D="reflectionFunction",_e=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=_e);const N="decalFragment",Me=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Me);const O="pbrBlockAlbedoOpacity",Fe=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=Fe);const _="pbrBlockReflectivity",Pe=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Pe);const M="pbrBlockAmbientOcclusion",Ue=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=Ue);const F="pbrBlockAlphaFresnel",be=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=be);const P="pbrBlockAnisotropic",xe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=xe);const U="pbrBlockReflection",ye=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=ye);const b="pbrBlockSheen",we=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=we);const x="pbrBlockClearcoat",Xe=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=Xe);const y="pbrBlockIridescence",Be=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=Be);const w="pbrBlockSubSurface",Ge=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=Ge);const X="clusteredLightingFunctions",He=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=He);const B="pbrBlockReflectance0",Ve=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ve);const G="pbrClusteredLightingFunctions",We=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=We);const H="pbrBlockNormalGeometric",ze=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=ze);const V="bumpFragment",ke=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=ke);const W="pbrBlockNormalFinal",Ye=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=Ye);const z="depthPrePass",$e=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=$e);const k="pbrBlockLightmapInit",Ke=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=Ke);const Y="pbrBlockGeometryInfo",qe=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=qe);const $="pbrBlockReflectance",Ze=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[$]||(e.IncludesShadersStore[$]=Ze);const K="pbrBlockDirectLighting",je=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=je);const q="lightFragment",Qe=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=Qe);const Z="pbrBlockFinalLitComponents",Je=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=Je);const j="pbrBlockFinalUnlitComponents",ei=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=ei);const Q="pbrBlockFinalColorComposition",ii=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=ii);const J="logDepthFragment",ti=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ti);const ee="pbrBlockImageProcessing",oi=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=oi);const ie="pbrBlockPrePass",ai=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[ie]||(e.IncludesShadersStore[ie]=ai);const te="oitFragment",ni=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[te]||(e.IncludesShadersStore[te]=ni);const oe="pbrDebug",ri=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[oe]||(e.IncludesShadersStore[oe]=ri);const i="pbrPixelShader",ae=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=ae);const di={name:i,shader:ae};export{di as pbrPixelShader};
