import{S as e}from"./bjs-scene8.js";import"./bjs-scene8-logDepthDeclaration-Bpyv9SFA.js";import"./bjs-scene8-fogFragment-CxxTav1S.js";import"./bjs-scene8-helperFunctions-CM4fuyjM.js";import"./bjs-scene8-hdrFilteringFunctions-BlQNpQdn.js";import"./bjs-scene8-pbrBRDFFunctions-DcYDoHcI.js";const t="prePassDeclaration",oe=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=oe);const o="oitDeclaration",ae=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=re);const r="pbrFragmentExtraDeclaration",fe=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=fe);const f="lightFragmentDeclaration",le=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=le);const l="lightUboDeclaration",ce=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=ce);const c="samplerFragmentDeclaration",se=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=se);const s="samplerFragmentAlternateDeclaration",de=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=de);const d="pbrFragmentSamplersDeclaration",ue=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ue);const u="imageProcessingDeclaration",Ee=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Ee);const E="subSurfaceScatteringFunctions",ve=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=ve);const v="pbrHelperFunctions",he=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=he);const h="imageProcessingFunctions",me=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=me);const m="shadowsFragmentFunctions",Se=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=pe);const p="pbrDirectLightingSetupFunctions",Ce=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Ce);const C="pbrDirectLightingFalloffFunctions",Re=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Re);const R="pbrDirectLightingFunctions",ge=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=ge);const g="pbrIBLFunctions",Ae=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Ae);const A="bumpFragmentMainFunctions",Ie=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Ie);const I="bumpFragmentFunctions",Te=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Te);const T="reflectionFunction",Le=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Le);const L="decalFragment",De=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=De);const D="pbrBlockAlbedoOpacity",Ne=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Ne);const N="pbrBlockReflectivity",Oe=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Oe);const O="pbrBlockAmbientOcclusion",Me=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=Me);const M="pbrBlockAlphaFresnel",_e=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=_e);const _="pbrBlockAnisotropic",Fe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Fe);const F="pbrBlockReflection",Pe=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Pe);const P="pbrBlockSheen",Ue=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Ue);const U="pbrBlockClearcoat",be=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=be);const b="pbrBlockIridescence",xe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=xe);const x="pbrBlockSubSurface",ye=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=ye);const y="clusteredLightingFunctions",we=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=we);const w="pbrBlockReflectance0",Xe=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=Xe);const X="pbrClusteredLightingFunctions",Be=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Be);const B="pbrBlockNormalGeometric",Ge=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ge);const G="bumpFragment",He=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=He);const H="pbrBlockNormalFinal",Ve=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=Ve);const V="depthPrePass",We=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=We);const W="pbrBlockLightmapInit",ze=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=ze);const z="pbrBlockGeometryInfo",ke=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=ke);const k="pbrBlockReflectance",Ye=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=Ye);const Y="pbrBlockDirectLighting",$e=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=$e);const $="lightFragment",Ke=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[$]||(e.IncludesShadersStore[$]=Ke);const K="pbrBlockFinalLitComponents",qe=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=qe);const q="pbrBlockFinalUnlitComponents",Ze=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=Ze);const Z="pbrBlockFinalColorComposition",je=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=je);const j="logDepthFragment",Qe=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=Qe);const Q="pbrBlockImageProcessing",Je=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=Je);const J="pbrBlockPrePass",ei=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ei);const ee="oitFragment",ii=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=ii);const ie="pbrDebug",ti=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[ie]||(e.IncludesShadersStore[ie]=ti);const i="pbrPixelShader",te=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=te);const ci={name:i,shader:te};export{ci as pbrPixelShader};
