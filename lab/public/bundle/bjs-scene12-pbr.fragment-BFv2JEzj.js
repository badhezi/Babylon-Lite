import{a6 as e}from"./bjs-scene12.js";import"./bjs-scene12-logDepthDeclaration-DcvURdBq.js";import"./bjs-scene12-helperFunctions-BRZPsIqB.js";const t="prePassDeclaration",ce=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ce);const o="oitDeclaration",se=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=ue);const r="pbrFragmentExtraDeclaration",Ee=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=Ee);const f="lightFragmentDeclaration",ve=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=ve);const l="lightUboDeclaration",he=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=he);const c="samplerFragmentDeclaration",me=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=me);const s="samplerFragmentAlternateDeclaration",Se=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=Se);const d="pbrFragmentSamplersDeclaration",pe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=pe);const u="imageProcessingDeclaration",Ce=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Ce);const E="clipPlaneFragmentDeclaration",Re=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Re);const v="fogFragmentDeclaration",ge=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ge);const h="subSurfaceScatteringFunctions",Ae=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Ae);const m="importanceSampling",Ie=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Ie);const S="pbrHelperFunctions",Te=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=Te);const p="imageProcessingFunctions",Le=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Le);const C="shadowsFragmentFunctions",De=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Ne);const g="pbrDirectLightingSetupFunctions",Oe=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Oe);const A="pbrDirectLightingFalloffFunctions",_e=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=_e);const I="hdrFilteringFunctions",Me=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Me);const T="pbrDirectLightingFunctions",Fe=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Fe);const L="pbrIBLFunctions",Pe=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Pe);const D="bumpFragmentMainFunctions",Ue=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Ue);const N="bumpFragmentFunctions",be=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=be);const O="reflectionFunction",xe=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=xe);const _="decalFragment",ye=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=ye);const M="pbrBlockAlbedoOpacity",we=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=we);const F="pbrBlockReflectivity",Xe=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Xe);const P="pbrBlockAmbientOcclusion",Be=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Be);const U="pbrBlockAlphaFresnel",Ge=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Ge);const b="pbrBlockAnisotropic",He=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=He);const x="pbrBlockReflection",Ve=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=Ve);const y="pbrBlockSheen",We=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=We);const w="pbrBlockClearcoat",ze=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=ze);const X="pbrBlockIridescence",ke=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=ke);const B="pbrBlockSubSurface",Ye=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ye);const G="clusteredLightingFunctions",$e=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=$e);const H="pbrBlockReflectance0",Ke=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=Ke);const V="pbrClusteredLightingFunctions",qe=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=qe);const W="clipPlaneFragment",Ze=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=Ze);const z="pbrBlockNormalGeometric",je=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=je);const k="bumpFragment",Qe=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=Qe);const Y="pbrBlockNormalFinal",Je=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=Je);const $="depthPrePass",ei=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[$]||(e.IncludesShadersStore[$]=ei);const K="pbrBlockLightmapInit",ii=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=ii);const q="pbrBlockGeometryInfo",ti=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=ti);const Z="pbrBlockReflectance",oi=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=oi);const j="pbrBlockDirectLighting",ai=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=ai);const Q="lightFragment",ni=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=ni);const J="pbrBlockFinalLitComponents",ri=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ri);const ee="pbrBlockFinalUnlitComponents",fi=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=fi);const ie="pbrBlockFinalColorComposition",li=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[ie]||(e.IncludesShadersStore[ie]=li);const te="logDepthFragment",ci=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[te]||(e.IncludesShadersStore[te]=ci);const oe="fogFragment",si=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[oe]||(e.IncludesShadersStore[oe]=si);const ae="pbrBlockImageProcessing",di=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[ae]||(e.IncludesShadersStore[ae]=di);const ne="pbrBlockPrePass",ui=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[ne]||(e.IncludesShadersStore[ne]=ui);const re="oitFragment",Ei=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[re]||(e.IncludesShadersStore[re]=Ei);const fe="pbrDebug",vi=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[fe]||(e.IncludesShadersStore[fe]=vi);const i="pbrPixelShader",le=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=le);const pi={name:i,shader:le};export{pi as pbrPixelShader};
