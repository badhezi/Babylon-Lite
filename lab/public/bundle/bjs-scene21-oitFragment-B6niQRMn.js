import{a7 as e}from"./bjs-scene21.js";const o="decalFragmentDeclaration",D=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=D);const t="prePassDeclaration",w=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=w);const r="oitDeclaration",E=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=E);const i="lightFragmentDeclaration",C=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=C);const a="lightUboDeclaration",x=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=P);const l="shadowsFragmentFunctions",T=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=T);const c="samplerFragmentDeclaration",L=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=L);const n="reflectionFunction",F=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=F);const d="imageProcessingDeclaration",y=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);const v="imageProcessingFunctions",A=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=A);const f="clipPlaneFragmentDeclaration",I=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=I);const h="fogFragmentDeclaration",M=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=M);const p="clipPlaneFragment",N=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=N);const u="depthPrePass",_=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=_);const m="logDepthFragment",U=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=U);const S="fogFragment",R=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=R);const g="oitFragment",z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=z);
